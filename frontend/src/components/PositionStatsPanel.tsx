...
export const PositionStatsPanel: React.FC<PositionStatsPanelProps> = ({ stats, isLoading }) => {
  ...
  if (isLoading) {
    return (
      <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-4 border border-blue-200 h-full">
  ...
  return (
    <div className="space-y-4 h-full flex flex-col">
      {/* 헤더 */}
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-4 text-white flex-shrink-0">
