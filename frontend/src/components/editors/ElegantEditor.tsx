            ...
            try {
                ...
                if (firstBlock && firstBlock.text) {
                    ...
                    if (actualData.name || actualData.title || actualData.about) {
                        ...
                        setTimeout(async () => {
                            console.log('🔧 ElegantEditor: Force updating HTML with correct template on initialization');
                            await updateHtml();
                        }, 100);
                    }
                                ...
                                <div className="space-y-4">
                                    {portfolioData.experience.map((exp, index) => (
                                        <motion.div
                                            ...
                                            className="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-purple-200 hover:shadow-md transition-all"
                                        >
                        ...
                        <BlurFade delay={0.3}>
                            <div className="bg-white rounded-xl border border-purple-200 p-6 shadow-sm">
                                ...
                                {portfolioData.projects.map((project, index) => (
                                    <div key={index} className="mb-4 p-4 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg border border-purple-200 shadow-sm">
                                        <div className="flex items-start justify-between mb-3">
                                            <input
                                                type="text"
                                                value={project.name || ''}
